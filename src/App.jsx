    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex ">
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-orange" href="https://www.webmotors.com.br/carros/estoque?lkid=1022" >Ver mais</a>
        </div>
        <div className="bg-green p-12">
          ...
          <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-green" href="https://www.webmotors.com.br/carros-novos/estoque?lkid=1001">Ver mais</a>
        </div>
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-dark-green" href="https://www.webmotors.com.br/carros-novos/estoque?lkid=1001">Ver mais</a>
        </div>
      </section>
    </main>
  )
